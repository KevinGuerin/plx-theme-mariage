...
-->
		<div class="article-body">
			...
			<div class="article-box">
				...
				<div class="article-detail-map"><img src="<?php $plxShow->racine(); ?>data/images/articles/<?php echo $plxShow->artId(); ?>.jpg" alt="<?php $plxShow->artTitle(); ?>" width="150" height="150" /></div>
